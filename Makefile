#############################################################################
# Makefile for building: Instalador\ DelphinOS
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Instalador\ DelphinOS1.0.0
DISTDIR = /mnt/Projects/QtGUI/.tmp/Instalador\ DelphinOS1.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		Makefile.pro QtGui.hpp main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = Instalador\ DelphinOS
DESTDIR       = 
...
all: Makefile Instalador\ DelphinOS
...
distdir: FORCE
	...
	$(COPY_FILE) --parents QtGui.hpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_QtGui.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_QtGui.cpp
moc_QtGui.cpp: QtGui.hpp \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /mnt/Projects/QtGUI/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/mnt/Projects/QtGUI -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/14.2.1 -I/usr/include/c++/14.2.1/x86_64-pc-linux-gnu -I/usr/include/c++/14.2.1/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/14.2.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/14.2.1/include-fixed -I/usr/include QtGui.hpp -o moc_QtGui.cpp
...
main.o: main.cpp QtGui.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

mainwindow.o: mainwindow.cpp QtGui.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mainwindow.o mainwindow.cpp

moc_QtGui.o: moc_QtGui.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_QtGui.o moc_QtGui.cpp
